...
// Styled components and animations (unchanged)
  ...
  return (
    ...
    >
      <DashboardContainer maxWidth="xl">
        ...
        {/* New nested grid for profile + right side cards on desktop */}
        <Grid container spacing={4} sx={{ mb: 4 }}>
          ...
          {/* Right side: Quick Actions, Top Performing Jobs, Quick Insights */}
        ...
        {/* Now the rest of the dashboard content below the profile + right side cards */}
